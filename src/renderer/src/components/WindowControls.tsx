...
export function WindowControls(): React.JSX.Element | null {
  ...
  useEffect(() => {
    ...
    // Why: the window can restore maximized before React mounts. Read once,
    // then subscribe so the maximize/restore glyph matches BrowserWindow state.
  ...
  if (!isWindows || windowState.isFullScreen) {
    return null
  }
