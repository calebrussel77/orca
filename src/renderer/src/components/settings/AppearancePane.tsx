...
export const APPEARANCE_PANE_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  ...
  },
  {
    ...
    description:
      'Scale the standard Orca interface text without changing code or terminal surfaces.',
...
export function AppearancePane({
  ...
  const titlebarEntries = APPEARANCE_PANE_SEARCH_ENTRIES.slice(5, 6)
      ...
      <section key="typography" className="space-y-4">
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            Customize normal Orca interface text separately from terminal and code views.
          </p>
        </div>
